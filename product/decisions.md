...
**Status:** Closed 2026-05-29 — implementation complete in luby/main (Waves 1–5 landed: BE-1 helper + BE-2 mobile-callback + FE-2/3/4/5 native libs & hook + FE-6 UI swap + Wave 4 Google removal + Wave 5 tests + this doc update). v0.2.0 ship + first-install verification on 48k's GrapheneOS Pixel pending Wave 6 (RE-1..8). Until v0.2.0 ships, workaround stands: open `https://myluby.net` in Vanadium / mobile browser; web Authentik flow works on GrapheneOS today.
